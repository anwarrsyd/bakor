...
<body>
 @if (Session::has('messagesuksesdelete'))
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	    ...
	    <li class="active"><a href="{{URL::to('rekapabsen')}}"><span class="glyphicon glyphicon-list-alt"></span>Data Absensi Pemandu</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Rekap Absensi Pemandu</h1>
